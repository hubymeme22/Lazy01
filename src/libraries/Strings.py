...
RETRIEVE_TOKEN = 'Retrieves the tokens based on the flow defined on configuration (see config/token-retrieval.conf.json)'
OUTPUT_DESCRIPTION = 'Specifies the output file for recorded browsing activity'
